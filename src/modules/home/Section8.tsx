  ...
  return (
    <section className="main-container mb-[120px]">
      <div className="bg-gradientPurple rounded-[20px] flex flex-col">
        <h3 className="max-w-[858px] mx-auto text-center text-white text-[34px] font-bold mb-[30px] mt-[70px]">
          We'll take the time to understand your goals and then help you create
          a website that's exactly what you envisioned.
        </h3>
        <p className="max-w-[692px] mx-auto text-center text-white mb-[40px]">
